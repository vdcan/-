        ...
        this.jq = $("#role").datagrid({
            ...
            columns: [[
 	                ...
 	                { field: 'role_code', title: '角色代码', width: 80, align: 'center', sortable: true },
                            { field: 'role_name', title: '角色名', width: 80, align: 'left', sortable: true },
                            { field: 'role_type', title: '角色类型', width: 80, align: 'left', sortable: true,formatter: function (value, row, index) {
                 var h = '未定义';
...
km.maingrid = {
    ...
    init: function () {
        ...
        //  fitColumns:true,
            columns: [[
                {
                    field: 'menu_name', title: '菜单名称', width: 180, align: 'left', formatter: function (value, row, index) {
                        var h = value;
                        if (row.menu_type == 1) {
                ...
                //{
                //    field: 'menu_type', title: '菜单说明', width: 100, align: 'left', formatter: function (value, row, index) {
                ...
                //        var h2 = '未定义';
                //        if (row.button_mode == 1) { h2 = '动态按钮'; } else if (row.button_mode == 2) { h2 = '静态按钮'; } else if (row.button_mode == 3) { h2 = '无按钮'; }
                //        var html = h + ' | ' + h2;
                //        return html;
                //    }
                //},
