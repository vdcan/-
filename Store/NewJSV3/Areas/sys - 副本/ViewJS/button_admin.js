            ...
            columns: [[
 	                ...
 	                { field: 'button_code', title: '按钮代码', width: 80, align: 'center', sortable: true },
                     {
                         field: 'button_name', title: '按钮名称', width: 150, align: 'left', sortable: true, formatter: function (value, row, index) {
                            ...
                            { field: 'button_type', title: '按钮类型', width: 80, align: 'left', sortable: true,formatter: function (value, row, index) {
                 var h = '未定义';
                            ...
                            { field: 'js_event', title: 'JS事件', width: 80, align: 'center', sortable: true },
