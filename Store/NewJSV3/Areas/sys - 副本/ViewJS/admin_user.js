    ...
    init: function () {
        this.jq = $("#xx_User").datagrid({
            ...
            columns: [[
 	              ...
 	              //  { field: 'user_type', title: '用户类型', width: 80, align: 'center', sortable: true },
                            { field: 'user_code', title: '用户代码', width: 80, align: 'center', sortable: true },
                            { field: 'real_name', title: '姓名', width: 80, align: 'center', sortable: true },
    ...
    init: function () {
        this.jq = $("#user_role").datagrid({
            ...
            columns: [[
 	             ...
 	             //   { field: 'user_id', title: '用户编号', width: 80, align: 'center', sortable: true },
                            { field: 'role_name', title: '角色', width: 80, align: 'left', sortable: false },
