...
km.menu = {
    ...
    init: function () {
        this.jq = $("#menu").treegrid({
            ...
            columns: [[
	            { field: 'menu_code', title: '菜单代码', width: 110, align: 'left' },
                { field: 'menu_name', title: '菜单名称', width: 130, align: 'left' },
                { field: 'url', title: '菜单URL', width: 180, align: 'left' },
                {
                    field: 'menu_type', title: '菜单类型', width: 55, align: 'center', formatter: function (value, row, index) {
                ...
                {
                    field: 'button_mode', title: '按钮模式', width: 55, align: 'center', formatter: function (value, row, index) {
...
// 	                { field: 'menu_code', title: '菜单代码', width: 80, align: 'center', sortable: true },
//                            { field: 'menu_name', title: '菜单名', width: 80, align: 'center', sortable: true },
//                            { field: 'parent_id', title: '父菜单编号', width: 80, align: 'center', sortable: true },
//                            { field: 'menu_type', title: '菜单类型', width: 80, align: 'center', sortable: true },
//                            { field: 'button_mode', title: '按钮模式', width: 80, align: 'left', sortable: true,formatter: function (value, row, index) {
//                 var h = '未定义';
...
//                            { field: 'icon_class', title: '图标类', width: 80, align: 'center', sortable: true },
        ...
        this.jq = $("#MenuButton").datagrid({
          ...
          //  url: km.model.urls["MenuButton_pager"],
            ...
            columns: [[
                              ...
                              //{ field: 'menu_id', title: '菜单编号', width: 100, align: 'center', sortable: true ,editor:{type:'textbox',options:{}}},
                        
                             
                              //{ field: 'button_id', title: '按钮编号', width: 100, align: 'center', sortable: true ,editor:{type:'textbox',options:{}}},
                        
                        {
                            field: 'button_id', title: '按钮名称', width: 150, align: 'left', sortable: true, formatter: function (value, row, index) {
                                return '&nbsp;&nbsp;<a href="#"><span class="icon ' + row.icon_class + '">&nbsp;</span>&nbsp;' + row.button_name + '</a>';
                            }
                        },
                             
                              { field: 'button_sort', title: '排序', width: 100, align: 'center', sortable: true ,editor:{type:'textbox',options:{}}},
                        
                             
                          { field: 'button_text', title: '按钮文字', width: 280, align: 'center', sortable: true ,editor:{type:'textbox',options:{}}},
    ...
    init: function () {
        this.jq = $("#button").datagrid({
            ...
            columns: [[
 	                ...
 	                { field: 'button_code', title: '按钮代码', width: 80, align: 'center', sortable: true }, {
 	                    field: 'button_name', title: '按钮名称', width: 150, align: 'left', sortable: true, formatter: function (value, row, index) {
 	                        return '&nbsp;&nbsp;<a href="#"><span class="icon ' + row.icon_class + '">&nbsp;</span>&nbsp;' + value + '</a>';
 	                    }
 	                },
                        //    { field: 'button_type', title: '按钮类型', width: 80, align: 'center', sortable: true },
                         //   { field: 'icon_class', title: '图标类', width: 80, align: 'center', sortable: true },
                            { field: 'remark', title: '备注', width: 80, align: 'center', sortable: true },
           ...
           // data: gMenuButtonData,
            ...
            columns: [[
            			...
            			},
                      {
 	                  ...
 	                  { field: 'button_code', title: '按钮代码', width: 80, align: 'left', sortable: true },
    ...
    init: function () {
        this.jq = $("#xx_Role").datagrid({
            ...
            columns: [[
 	                ...
 	                { field: 'role_code', title: '角色代码', width: 80, align: 'center', sortable: true },
                            { field: 'role_name', title: '角色名', width: 80, align: 'center', sortable: true },
