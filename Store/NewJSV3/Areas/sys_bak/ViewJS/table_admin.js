...
km.table_list= {
    ...
    init: function () {
        this.jq = $("#table_list").datagrid({
            ...
            columns: [[
                          ...
                          { field: 'table_name', title: '表名', width: 180, align: 'left', sortable: true ,editor:{type:'textbox',options:{}}},
                          
                             
                          { field: 'description', title: '描述', width: 280, align: 'left', sortable: true, editor: { type: 'textbox', options: {} } },
    ...
    getSelectedRow: function () { return this.jq.datagrid('getSelected'); }
		...
		function removeit_table_list(){
			if (editIndextable_list == undefined){layer.msg('请选择一条记录！'); return; }
...
km.column_list= {
    ...
    init: function () {
        this.jq = $("#column_list").datagrid({
            ...
            columns: [[
                          ...
                          //{ field: 'table_name', title: '表名', width: 80, align: 'left', sortable: true },
                          
                             
                          { field: 'column_name', title: '列名', width: 180, align: 'left', sortable: true },
                          { field: 'caption', title: '列标题', width: 280, align: 'left', sortable: true, editor: { type: 'textbox', options: {} } },
                          
                             
                          { field: 'description', title: '描述', width: 380, align: 'left', sortable: true, editor: { type: 'textbox', options: {} } },
    ...
    getSelectedRow: function () { return this.jq.datagrid('getSelected'); }
		...
		function removeit_column_list(){
			if (editIndexcolumn_list == undefined){layer.msg('请选择一条记录！'); return; }
		...
		function add_default() {
		    var row = $('#table_list').datagrid('getSelected'); 
		    var a = [{ col: 'id', caption: '编号' }, { col: 'add_on', caption: '创建日期' }, { col: 'add_by', caption: '创建人' }, { col: 'description', caption: '描述' },
                { col: 'comments', caption: '注释' }, { col: 'department_id', caption: '部门编号' }, ];
		    for (var i = 0; i < a.length; i++)
		    {
