...
km.flow_lines= {
        ...
        this.jq = $("#flow_lines").datagrid({
            ...
            columns: [[
                         ...
                         //     { field: 'flow_id', title: '流程编号', width: 100, align: 'center', sortable: true ,editor:{type:'textbox',options:{}}},
                          ...
                          { field: 'name', title: '条件', width: 280, align: 'center', sortable: true ,editor:{type:'textbox',options:{}}},
                          
                             
                          { field: 'from', title: '到节点', width: 280, align: 'center', sortable: true ,editor:{type:'textbox',options:{}}},
                          
                             
                          { field: 'to', title: '从节点', width: 280, align: 'center', sortable: true ,editor:{type:'textbox',options:{}}},
                          
                             
                          { field: 'gf_id', title: '条件编号', width: 280, align: 'center', sortable: true ,editor:{type:'textbox',options:{}}},
    ...
    getSelectedRow: function () { return this.jq.datagrid('getSelected'); }
		...
		function removeit_flow_lines(){
			if (editIndexflow_lines == undefined){layer.msg('请选择一条记录！'); return; }
...
km.toolbar1 = {
    ...
    do_edit: function () {
        ...
        if (km.flow.selectedRow == null) { layer.msg('请选择一条记录！'); return; }
    ...
    do_delete: function () {
        ...
        //if (km.model.loginer.IsSuperAdmin == 0 && sRow.AllowEdit == 0) { layer.msg('此参数不可删除！'); return; }
        var jsonParam = JSON.stringify(sRow);
        com.message('c', ' <b style="color:red">确定要删除流程表【' + sRow.id + '】吗？ </b>', function (b) {
            if (b) {
                com.ajax({
    ...
    init: function () {
        this.jq = $("#flow_nodes").datagrid({
            ...
            columns: [[
                          ...
                          { field: 'name', title: '节点名称', width: 280, align: 'center', sortable: true ,editor:{type:'textbox',options:{}}},
                          
                             
                              { field: 'type', title: '节点类型', width: 200, align: 'center', sortable: true ,editor:{type:'textbox',options:{}}},
                        
                             
                            //  { field: 'flow_id', title: '流程编号', width: 100, align: 'center', sortable: true ,editor:{type:'textbox',options:{}}},
                        
                             
                          { field: 'gf_id', title: '节点编号', width: 280, align: 'center', sortable: true ,editor:{type:'textbox',options:{}}},
                          
                             
                            { field: 'can_cancel', title: '是否可取消', width: 100, align: 'center', sortable: true ,editor:{type:'textbox',options:{}}},
                        
                             
                          { field: 'page_type', title: '页面类型', width: 280, align: 'center', sortable: true ,editor:{type:'textbox',options:{}}},
                          
                             
                          { field: 'status', title: '状态', width: 280, align: 'center', sortable: true ,editor:{type:'textbox',options:{}}},
...
km.flow_status= {
    ...
    init: function () {
        this.jq = $("#flow_status").datagrid({
            ...
            columns: [[
                              ...
                              { field: 'status', title: '状态', width: 200, align: 'center', sortable: true ,editor:{type:'textbox',options:{}}},
                        
                             
                          { field: 'status_text', title: '状态名', width: 280, align: 'center', sortable: true ,editor:{type:'textbox',options:{}}},
    ...
    getSelectedRow: function () { return this.jq.datagrid('getSelected'); }
		...
		function removeit_flow_status(){
			if (editIndexflow_status == undefined){layer.msg('请选择一条记录！'); return; }
