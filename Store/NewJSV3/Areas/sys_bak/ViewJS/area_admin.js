    ...
    init: function () {
        this.jq = $("#area").datagrid({
            ...
            columns: [[
 	                ...
 	                { field: 'area_name', title: '区域名', width: 80, align: 'center', sortable: true },
    // {
...
km.toolbar = {
    ...
    do_edit: function () {
        ...
        if (km.area.selectedRow == null) { layer.msg('请选择一条记录！'); return; }
...
km.controller= {
    ...
    init: function () {
        this.jq = $("#controller").datagrid({
            ...
            columns: [[
               	        { field: 'controller_name', title: '控制器名', width: 280, align: 'center', sortable: true, editor: { type: 'textbox', options: {} } },
            ]],
    ...
    getSelectedRow: function () { return this.jq.datagrid('getSelected'); }
		...
		function removeit_controller(){
			if (editIndexcontroller == undefined){layer.msg('请选择一条记录！'); return; }
