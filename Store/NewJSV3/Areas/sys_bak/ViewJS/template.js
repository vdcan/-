        ...
        this.jq = $("#xx_templategrid").datagrid({
            ...
            columns: [[
 	                ...
 	                { field: 'id', title: '编号', width: 40, align: 'center', sortable: true },
                            { field: 'template_name', title: '模板名称', width: 80, align: 'left', sortable: true },
                        //    { field: 'description', title: '描述', width: 180, align: 'left', sortable: true },
                            //{ field: 'files', title: '文件', width: 80, align: 'center', sortable: true },
                            //{ field: 'html', title: 'html', width: 80, align: 'center', sortable: true },
                            { field: 'areas', title: '对应区域', width: 40, align: 'left', sortable: true },
                            { field: 'language', title: '语言', width: 50, align: 'center', sortable: true },
...
km.toolbar = {
    ...
    do_edit: function () {
        ...
        if (km.xx_templategrid.selectedRow == null) { layer.msg('请选择一条记录！'); return; }
        km.set_mode('edit');
    ...
    do_delete: function () {
        ...
        com.message('c', ' <b style="color:red">确定要删除模板【' + sRow.id + '】吗？ </b>', function (b) {
            if (b) {
                com.ajax({
...
//                              //{ field: 'module_id', title: '模块编号', width: 50, align: 'center', sortable: true, editor: { type: 'textbox', options: {} } },


//                          {
//                              field: 'file', title: '文件', width: 280, align: 'left', sortable: true, editor: {
//                              type: 'combotree',
//                                         options: {
//                                             data: gTemplates,
...
//                              //{ field: 'target', title: '目标区域', width: 100, align: 'center', sortable: true, editor: { type: 'textbox', options: {} } },


//                                 {
//                                     field: 'type', title: '类型', width: 280, align: 'left', sortable: true, formatter: function (value, row) {
//                                         return value;
//                                     },
//                                     editor: {
//                                         type: 'combobox',
...
// //                         {
// //                             field: 'button_name', title: '按钮', width: 280, align: 'center', sortable: true, formatter: function (value, row) {
// //                                 return value;
// //                             },
// //                             editor: {
// //                                 type: 'combobox',
...
// //                         },
// //                         {
// //                             field: 'action_type', title: '动作', width: 280, align: 'center', sortable: true, formatter: function (value, row) {
// //                                 return value;
// //                             },
// //                             editor: {
// //                                 type: 'combobox',
...
//    if (editIndexxx_module_files == undefined) { layer.msg('请选择一条记录！'); return; }
        ...
        this.jq = $("#xx_module_grid").datagrid({
            ...
            columns: [[

                   {
 	                ...
 	                { field: 'module_name', title: '模块名', width: 80, align: 'center', sortable: true },
...
function SetModule(uid) {
    ...
    var jsonParam = JSON.stringify({ template_id: km.xx_templategrid.selectedRow.id, module_id: uid  });
    // alert(jsonParam);
    // return;
    com.ajax({
