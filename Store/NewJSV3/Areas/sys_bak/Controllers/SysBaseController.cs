...
namespace JSBase.Areas.Sys.Controllers
{
    public class SysBaseController : BaseController
    {
        ...
        public JsonResult ResetPasswrod(JObject data)
        {
            ...
            return Json(new { s = true, message = "成功" }, JsonRequestBehavior.DenyGet);
        }
        public JsonResult GenerateCode(JObject data)
        {
            ...
            if (r3 == null)
            {
                ...
                return JsonNet(new { s = false, message = "失败" });
            }
            else
            {
                ...
                return JsonNet(new { s = true, message = "成功" });
            }
        ...
        public JsonResult Synchronize(JObject data)
        {
            ...
            for (int i = 0; i < r3.templates.Length; i++)
            {
                ...
                data["JSFramework"] = r3.templates[i].JSFramework;
            ...
            for (int i = 0; i < r3.modules.Length; i++)
            {
                ...
                data["JSFramework"] = r3.modules[i].JSFramework;
                data["clean_table_flag"] = i;
        ...
        {
            return JsonNet(new { message = "成功", r = 1 });
        }
        public JsonResult publish(JObject data)
        {
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                if (f.EndsWith(".js"))
                {
                    ...
                    if (dt.Rows[0]["controller_area"].ToString() == "")
                    {
                ...
                {
                    if (dt.Rows[0]["controller_area"].ToString() == "")
                        p2 = p2 + "\\Views\\" + dt.Rows[0]["controller"].ToString() + "\\";
                    else
                ...
                return JsonNet(new { message = "失败", r = 0 });
        }
        ...
        public JsonResult Save(JObject data)
        {
            ...
            return JsonNet(new { message = "成功", r = 0 });
        }
