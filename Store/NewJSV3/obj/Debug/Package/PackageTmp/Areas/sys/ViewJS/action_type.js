    ...
    init: function () {
        this.jq = $("#action_type").datagrid({
            ...
            columns: [[
                ...
                { field: 'code_help', title: '程序助手', width: 80, align: 'center', sortable: true },
                { field: 'description', title: '描述', width: 80, align: 'center', sortable: true },
                { field: 'id', title: '编号', width: 80, align: 'center', sortable: true },
                { field: 'type', title: '动作类型', width: 80, align: 'center', sortable: true },
                { field: 'type_name', title: '动作类型名', width: 80, align: 'center', sortable: true },
     {
...
km.toolbar = {
    ...
    do_edit: function () {
        ...
        if (km.action_type.selectedRow == null) { layer.msg('请选择一条记录！'); return; }
