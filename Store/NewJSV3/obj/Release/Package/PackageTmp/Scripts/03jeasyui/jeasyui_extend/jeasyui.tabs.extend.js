...
$.extend($.fn.tabs.methods, {
    ...
    loadTabIframe: function (jq, params) {
        ...
        return jq.each(function () {
            ...
            var $maskMessage = $('<div class="mask-message" style="z-index:1001;width:auto;height:16px;line-height:16px;position:absolute;top:50%;left:50%;margin-top:-20px;margin-left:-92px;border:2px dashed #75186D;padding: 12px 5px 10px 30px;background: #ffffff url(\'/Scripts/03jeasyui/jeasyui_extend/images/ajax-loader.gif\') no-repeat scroll 5px center;">' + (params.iframe.message || 'loading ...') + '</div>').appendTo($parentBody);
